...
end, false, "Nocollides <ent> to entities/players, just like Right Click of No-Collide Stool");
...
end, false, "Breaks every constraint on <ent>");
...
end, false, "Breaks all constraints of type <type> on <ent>");
