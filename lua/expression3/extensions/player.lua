...
extension:RegisterMethod("p", "health", "", "n", 1, Armor)
extension:RegisterMethod("p", "steamFriendStatus", "", "s", 1, GetFriendStatus)

extension:RegisterMethod("p", "aimPos", "", "v", 1, function(p) return p:GetEyeTrace().HitPos end)
extension:RegisterMethod("p", "aimEntity", "", "e", 1, function(p) return p:GetEyeTrace().Entity end)
extension:RegisterMethod("p", "eyeTrace", "", "t", 1, function(p) return p:GetEyeTrace() end)
